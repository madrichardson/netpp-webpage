...
<h4><strong>Legacy Product</strong></h4>
  ...
  <p>The VIIRS SNPP interim netPP product uses chlorophyll, sea surface temperature and photosynthetically active radiation derived from the VIIRS sensor on the SNPP satellite. The dataset begins in 2012 and continues to the present, offering daily and monthly versions of the dataset.</p>

  <h4><strong>VIIRS NOAA20 Interim Product</strong></h4>
  <p>The VIIRS NOAA20 interim netPP product uses chlorophyll, sea surface temperature and photosynthetically active radiation derived from the VIIRS sensor on the NOAA20 satellite. The dataset begins in 2018 and continues to the present, offering daily and monthly versions of the dataset.</p>
