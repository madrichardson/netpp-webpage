...
For VIIRS NOAA20 interim product relative to the legacy product, monthly mean global &psi; 

::: {style="text-align: center;"}
<span style="font-size: 1.5em; font-weight: bold;">Timeseries: Monthly Means of Unbiased Relative Difference</span>

![psi Timeseries](images/greyscale_psi_timeseries.png){.lightbox  width=100% style="max-width: 1600px;" }
...
![psi Spatial Map](images/new_psi_comparison.png){.lightbox width=100%}
**Figure 3.** Global maps of the multi-year mean unbiased relative difference (&psi;) comparing VIIRS-SNPP(3a) and VIIRS-NOAA(3b) with MODIS-Aqua. Positive (blue) values indicate that the interim product netPP values are larger than those of the legacy product and negative (red) values indicate that the interim product netPP values are less than those of the legacy product.
:::
...
![global trends](images/trends_with_centered_colorbar.png){.lightbox width=100%}
