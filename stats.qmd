...
### Spatial Variability in the Timeseries Monthly &psi; Mean

::: {style="text-align: center;"}
![Figure ](images/modis_viirs_psi_comparison.png){width=600px}
:::

### Comparing the Best and Worst Fit Longhurst Provinces

::: {style="text-align: center;"}
![Figure ](images/best_worst_psi_snpp.png){width=800px}
:::
...
::: {style="text-align: center;"}
![Figure ](images/bestVSworstLonghurstPronvince.png){width=800px}
:::
...
<p>The mean biased relative difference (&Delta;<sub>rel</sub>) of the interim VIIRS netPP product (netPP<sub>VIIRS</sub>) and legacy MODIS netPP product (netPP<sub>MODIS</sub>) was calculated.</p>

<p>The pixel-by-pixel mean biased relative difference (&Delta;<sub>rel</sub>) was created for the globe for each month at 9km resolution across two datasets:</p>

<a href="https://coastwatch.pfeg.noaa.gov/wcn/erddap/griddap/netpp_delta_snpp_modis.graph" target="_blank" style="text-decoration: none; color: #0072ce;">**Biased Relative Difference, VIIRS-SNPP - MODIS-Aqua Global, Monthly, 9km, 2013-2022**</a>

<a href="https://coastwatch.pfeg.noaa.gov/wcn/erddap/griddap/netpp_psi_noaa20_modis.graph" target="_blank" style="text-decoration: none; color: #0072ce;">**Biased Relative Difference, VIIRS-NOAA20 - MODIS-Aqua Global, Monthly, 9km, 2018-2022**</a>
...
::: {style="text-align: center;"}
![Figure ](images/modis_viirs_delta_comparison.png){width=600px}
:::
...
<p> The Pearson correlation coefficient was calculated for each pixel over the time dimension for each of these datasets:</p>
