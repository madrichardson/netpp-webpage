...
::: {style="text-align: center;"}
![Figure 3.](images/modis_viirs_corr_comparison.png){width=600px}
:::
...
::: {style="text-align: center;"}
![Figure 4.](images/modis_snpp_trends_comparison.png){width=600px}
:::

### MODIS vs NOAA20 (2018-2022)

::: {style="text-align: center;"}
![Figure 5.](images/modis_noaa20_trends_comparison.png){width=600px}
:::
...
::: {style="text-align: center;"}
![Figure 6.](images/global_modis_snpp_contingency.png){width=1200px}
:::

### MODIS vs NOAA20 (2018-2022)

::: {style="text-align: center;"}
![Figure 7.](images/global_modis_noaa20_contingency.png){width=1200px}
:::
